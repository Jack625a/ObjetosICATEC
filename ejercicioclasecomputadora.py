#ejercicio 1- crear una clase de calculadora 
#
class Calculadora:
    def __init__(self):
        self.resultado=0
#acciones o metodos de la clase - sumar, restar, Multiplicar, dividir.
...
#creacion de los objetos que pertenecen al clase
